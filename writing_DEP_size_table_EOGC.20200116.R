...
a <- a %>% rename('Sample_ID' = 'V1', 'Total_Protein' = 'V2', 'DEP_Peptide_Up' = 'V3', 
                  'DEP_Peptide_Down' = 'V4', 'DEP_up_Nitrated_Protein' = 'V5', 
                  'DEP_down_Nitrated_Protein' = 'V6', 
                  'DEP_up_NonNitrated_Protein' = 'V7',
                  'DEP_down_NonNitrated_Protein' = 'V8',
                  'NonDEP_Nitrated_Protein' = 'V9',
                  'NonDEP_NonNitrated_Protein' = 'V10')
