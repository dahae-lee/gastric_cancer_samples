# 데이터의 상위 폴더를 dir에 지정
dir = "~/GoogleDrive/gastric_cancer_samples/Tables/data_QC.20200417/"
date = '20200421'
...
tmp <- lapply(seq(1,95), function(i){
...
# Save to file
a_out = paste('~/GoogleDrive/gastric_cancer_samples/Tables/table.data_QC', date, 'txt', sep='.')
