...
blast_db = "/Users/joonan/Dropbox/Collaborations/EOGC_Nitration/db/Uniprot_homo_sapiens_20170724_reviewed.fasta"
input = "test.fa"
evalue = 1e-6
format = 6
nThreads = ifelse(parallel::detectCores()==16, 12, 2)
f_blastp = paste('Tables/table.blastp', sample, 'txt.gz', sep='.')
...
res = read.table(f_blastp, header = F, col.names = c('pid', 'sseqid', 'pident', 'length', 'mismatch', 'gapopen', 'qstart', 'qend', 'sstart', 'send', 'evalue', 'bitscore'))
